...
namespace mRemoteNG.UI.Forms.OptionsPages
{
    public partial class ConnectionsPage
    {
        ...
        public ConnectionsPage(frmMain mainForm)
        {
            InitializeComponent();
            _mainForm = mainForm;
        }
        ...
        public override void SaveSettings()
        {
            ...
            {
                _mainForm.tmrAutoSave.Interval = Convert.ToInt32(Settings.Default.AutoSaveEveryMinutes*60000);
                _mainForm.tmrAutoSave.Enabled = true;
            }
            else
            {
                _mainForm.tmrAutoSave.Enabled = false;
            }
